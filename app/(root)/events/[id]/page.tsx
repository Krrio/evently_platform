...
const EventDetails = async ({ params: { id }, searchParams }: SearchParamProps) => {
  ...
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 2xl:max-w-7xl">
            ...
            <div className="flex w-full flex-col gap-8 p-5 md:p-10">
                <div className="flex flex-col gap-6">
                    ...
                    sm:items-center">
                        <div className="flex gap-3">
                            ...
                            <p className="p-medium-16 rounded-full bg-grey-500/10 
                        ...
                        <p className="p-medium-18 ml-2 mt-2 sm:mt-0">
                            by{' '}
                            <span className="text-primary-500">{event.organizer.firstName} 
                ...
                <div className="flex flex-col gap-2">
                    <p className="p-bold-20 text-grey-600">Co otrzymujesz?</p>
                    <p className="p-medium-16 lg:p-regular-18">{event.description}</p>
                    <p className="p-medium-16 lg:p-regular-18 truncate 
                    text-primary-500 underline">{event.url}</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section className="wrapper my-8 flex flex-col gap-8 md:gap-12">
        <h2 className="h2-bold">Podobne wydarzenia</h2>
